...
export const experiences = [
    {
        "id": 0,
        "img": "https://www.finari.com/assets/logo.png", // Replace with an actual image URL
        "role": "Full Stack Developer Intern",
        "company": "Finari Services Private Limited",
        "date": "Nov 2024 - Dec 2024",
        "desc": "Developed and maintained core features of a web application using React.js, ensuring a responsive and user-friendly interface. Collaborated with the team to design intuitive user interfaces and improve application functionality. Integrated APIs to enhance frontend-backend communication and optimize performance.",
        "skills": [
          "React.js",
          "Node Js",
          "API Integration",
        ...
        // "doc": """ // Replace with an actual certificate URL
      }
...
export const projects = [
  {
    id: 0,
    title: "NPVR Cart (E-Commerce Website)",
    date: "Sep 2024 - Oct 2024",
    description:
      "Built a full-stack e-commerce application using the MERN stack, featuring user authentication and product management. Developed RESTful APIs to handle product and order management between the client and server. Implemented a responsive UI with dynamic product listings and integrated MongoDB for persistent data storage.",
